...
powertrain = Powertrain.DirectTransmission(motor, 5, transmission_efficiency=0.93)
...
vehicle_results = v.simulate(track, 0, [0, 0], control_function=control.demand, time_step=0.0025, time_limit=500, lap_limit=1)
