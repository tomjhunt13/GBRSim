...
powertrain = Moog_C42_L90_10(verbose=True)
...
vehicle_results = v.simulate(track, 0, [0, 0], control_function=control.demand, time_step=0.01, time_limit=1000, lap_limit=2)
